      ...
      try {
        ...
        if (answer.scss_structure == "blank") {
          ...
          folders.forEach(function (item) {
            fs.rm(`${answer.scss_path}${slash}scss/${item}`, { recursive: true }); // remove folder from create-scss structure base on user selection
            // fs.readFile( "mik/scss/main.scss",{ encoding: "utf-8" }, // file to update 
            // fs.readFile( "main.scss",{ encoding: "utf-8" }, // file to update 
            // fs.readFileSync(path.join(__dirname, `${answer.scss_path}/`) + 'scss/main.scss', 'utf8', // !!!!!!!!!!!!!!!!!!!!!!
            fs.readFile(`${answer.scss_path}/scss/main.scss`, 'utf8', // !!!!!!!!!!!!!!!!!!!!!!
            ...
            function (err, data) {
              ...
              let result = dataArray.filter(function (dataItem) { // **TODO** fonction trouver le moyen de convertir array searchWords en array de regex (retirer les quotes)
              ...
              // fs.writeFile('mik/scss/main.scss', 'hello world', (err) => { // file -> main.scss
                // fs.writeFile(`${answer.scss_path}${slash}scss/main.scss`, updateFile, (err) => { 
                  // fs.writeFileSync(path.join(__dirname, `${answer.scss_path}/scss/main.scssn`), updateFile, (err) => { // !!!!!!!!!!!!!!!!!!!!!!
              // fs.writeFileSync(`${answer.scss_path}/scss/main.scss`, 'hello world', (err) => { // !!!!!!!!!!!!!!!!!!!!!!
